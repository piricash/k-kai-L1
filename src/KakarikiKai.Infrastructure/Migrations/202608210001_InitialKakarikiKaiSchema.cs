...
public partial class InitialKakarikiKaiSchema : Migration
{
    ...
    {
        // The Azure database was provisioned before this repository acquired a committed
        // migration history. Every operation is additive so a pre-existing test schema
        // is adopted without dropping tables or operational rows.
